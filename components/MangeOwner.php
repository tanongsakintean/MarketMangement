    ...
    <div class="page-header">
        <div class="row">
            <div class="col-lg-6 main-header">
                <h2>จัดการ<span>เจ้าของที่ </span></h2>
            </div>
            <div class="col-lg-6 breadcrumb-right">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php"><i class="pe-7s-home"></i></a></li>
                    <li class="breadcrumb-item active">จัดการเจ้าของที่</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="container-fluid">
    <div class="row" style=" margin-bottom: 2rem ;">
        ...
        <button class="btn btn-primary" type="button" data-toggle="modal" data-target=".addUser">เพิ่มเจ้าของที่</button>
        <div class="modal fade addUser" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myLargeModalLabel">เพิ่มเจ้าของที่</h4>
                    ...
                    <div class="modal-body" style="padding:2rem;">
                        <form class="addUser-validation" id="form" novalidate="">
                            ...
                            <input type="number" value="1" id="user_level" class="d-none">
                            <div class="d-flex justify-content-end">
                                <button class="btn btn-primary" type="submit">เพิ่มเจ้าของที่</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="table-responsive" id="user">
                        ...
                        <div class="modal fade editUser" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myLargeModalLabel">แก้ไขเจ้าของที่</h4>
                                        <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                    </div>
                                    <div class="modal-body" style="padding:2rem;">
                                        <form class="edit-validation" id="form" novalidate="">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <label for="validationCustomUsername">รหัสไปรษณีย์<span class="text-danger">*</span></label>
                                                    <div class="input-group">
                                                        <input type="text" id="role_id" value="2" class="d-none">
                        ...
                        <div class="modal fade infoUser" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                            <div class="modal-dialog ">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myLargeModalLabel">รายละเอียดเจ้าของที่</h4>
                                        <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                    </div>
                                    <div class="modal-body" style="padding: 2rem;">
    ...
    let form = new Vue({
        ...
        methods: {
            ...
            getUser() {
                ...
                axios.get("./apis/api_getOwener.php")
                    .then((res) => {
                        let {
                            status,
                            user
