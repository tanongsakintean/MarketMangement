...
if (isset($req)) {
    switch ($req->action) {
        case 'MonthPay':
            ...
            VALUES ('" . $req->user_id . "','" . $req->rental_type . "','" . $req->area_id . "','" . $req->market_id . "','0','" . $req->money . "','" . $req->date_start . "','" . date("Y-m-d", strtotime('+1 month', strtotime($req->date_start))) . "','30','" . date("Y-m-d") . "',0)");
