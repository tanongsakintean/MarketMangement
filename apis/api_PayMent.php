    ...
    switch ($_REQUEST['action']) {
        case 'payment':
            ...
            if ($status == 0) {
                ...
                VALUES ('" . $_SESSION['ses_userId'] . "','" . $_REQUEST['rental_type'] . "','" . $_REQUEST['area_id'] . "','" . $_REQUEST['market_id']. "','" . substr($img, 0, -1) . "','" . $_REQUEST['money'] . "','" . $_REQUEST['date_start'] . "','" . date("Y-m-d", strtotime('+1 month', strtotime($_REQUEST['date_start']))) . "','30','" . date("Y-m-d") . "',0)");
                ...
                if ($statement) {
                    ...
                    if ($statement) {
                        ...
                        $statement = $conn->query("INSERT INTO tb_notify (rental_id,type_status,noti_date,del_status) VALUES ('" . $max_id->max_id . "',2,'" . date("Y/m/d") . "',0)");
                        if ($statement) {
